...
export default function BlogPostPage({ params, initialArticle }: { params: Promise<{ slug: string }>, initialArticle: News | null }) {
  ...
  const handleShareX = () => {
    const url = `https://twitter.com/intent/tweet?url=${encodeURIComponent(shareUrl)}&text=${encodeURIComponent(article?.title || "")}`;
          ...
          <div className="sticky top-32">
            ...
            <div className="flex items-center gap-3">
              <button 
                ...
                className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-[#94a3b8] hover:text-white hover:border-white/30 hover:bg-white/5 transition-all"
                title="Share on X"
              >
              ...
              <button 
                ...
                className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-[#94a3b8] hover:text-[#0a66c2] hover:border-[#0a66c2]/30 hover:bg-[#0a66c2]/5 transition-all"
        ...
        <div className="md:col-span-7">
          ...
          <div className="flex md:hidden items-center justify-between gap-4 mb-10 border-b border-white/10 pb-6">
            ...
            <div className="flex items-center gap-2">
              <button 
                onClick={handleShareX}
                className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center text-[#94a3b8] hover:text-white"
                title="Share on X"
              >
              ...
              <button 
                onClick={handleShareLinkedIn}
                className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center text-[#94a3b8] hover:text-[#0a66c2]"
                title="Share on LinkedIn"
              >
                <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
                  <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0z"/>
